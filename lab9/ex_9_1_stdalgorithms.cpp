 ...
 *  Exercise 1.  STL algorithms
 In the file ex_9_1_stdalgorithms.cpp you will find comments with tasks descriptions. They should
be implemented without any loop, only by calling appropriate STL algorithm (one line is needed in
most cases).
 */
